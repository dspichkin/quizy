    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_query_name=b'lesson', related_name='lessons', verbose_name=b'\xd1\x81\xd0\xbe\xd0\xb7\xd0\xb4\xd0\xb0\xd1\x82\xd0\xb5\xd0\xbb\xd1\x8c', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name=b'\xd1\x83\xd1\x80\xd0\xbe\xd0\xba \xd0\xb4\xd0\xbe\xd1\x81\xd1\x82\xd1\x83\xd0\xbf\xd0\xb5\xd0\xbd?')),
                ('is_passed', models.BooleanField(default=False, verbose_name=b'\xd0\xbf\xd1\x80\xd0\xbe\xd0\xb9\xd0\xb4\xd0\xb5\xd0\xbd?')),
                ...
                ('learner', models.ForeignKey(related_query_name=b'enroll', related_name='enrolls', editable=False, to=settings.AUTH_USER_MODEL, verbose_name=b'\xd0\xbe\xd0\xb1\xd1\x83\xd1\x87\xd0\xb0\xd0\xb5\xd0\xbc\xd1\x8b\xd0\xb9')),
                ('lesson', models.ForeignKey(related_query_name=b'enroll', related_name='enrolls', editable=False, to='quizy.Lesson', verbose_name=b'\xd0\xba\xd1\x83\xd1\x80\xd1\x81')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(related_name='variants', to='quizy.Page')),
            ],
            options={
                'ordering': ('number', 'created_at', 'text'),
                'verbose_name': '\u041e\u0442\u0432\u0435\u0442',
