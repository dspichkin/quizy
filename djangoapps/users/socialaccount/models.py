...
import users.app_settings
# from users.account.models import EmailAddress
from users.account.utils import get_next_redirect_url #, setup_user_email
...
class SocialAccount(models.Model):
    user = models.ForeignKey(users.app_settings.USER_MODEL)
    provider = models.CharField(verbose_name=_('provider'),
                                max_length=30,
                                choices=providers.registry.as_choices())
