...
class Migration(SchemaMigration):
    depends_on = []
    if 'users.socialaccount.providers.facebook' in settings.INSTALLED_APPS:
        depends_on.append(('facebook', '0003_tosocialaccount'),)
    if 'users.socialaccount.providers.twitter' in settings.INSTALLED_APPS:
        depends_on.append(('twitter', '0003_tosocialaccount'),)
    if 'users.socialaccount.providers.openid' in settings.INSTALLED_APPS:
