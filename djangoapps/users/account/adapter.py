...
from ..utils import (import_attribute, get_user_model, get_user_confirm_model,
...
class DefaultAccountAdapter(object):
    ...
    def save_user(self, request, user, form, commit=True):
        ...
        if account_type and account_type == 1:
            user_field(user, 'account_type', account_type)
        elif account_type and account_type == 2:
            user_field(user, 'account_type', account_type)
        else:
            user_field(user, 'account_type', 1)
    ...
    def confirm_email(self, request, user):
        ...
        user.save()
        try:
            get_user_confirm_model().objects.get(user=user).delete()
        except get_user_confirm_model().DoesNotExist:
            pass
