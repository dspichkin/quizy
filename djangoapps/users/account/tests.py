...
from users.account.forms import BaseSignupForm
from users.account.models import EmailAddress, EmailConfirmation
from users.utils import get_user_model, get_current_site
...
@override_settings(
    ...
    ACCOUNT_ADAPTER='users.account.adapter.DefaultAccountAdapter',
    ACCOUNT_USERNAME_REQUIRED=True)
class AccountTests(TestCase):
    def setUp(self):
        if 'users.socialaccount' in settings.INSTALLED_APPS:
